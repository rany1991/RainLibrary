...
// - inside the triangle
		...
		static public function InPoints(w:b2Vec2, points:Array, pointCount:int):Boolean
		{
			...
			for (var i:int=0; i < pointCount; ++i)
			{
				...
				if (dX < k_tolerance * (mX + 1.0) && dY < k_tolerance * (mY + 1.0))
				{
					return true;
				}
			}
...
//
		...
		static public function DistanceCC(x1:b2Vec2, x2:b2Vec2, circle1:b2CircleShape, xf1:b2XForm, circle2:b2CircleShape, xf2:b2XForm):Number
		{
			var tMat:b2Mat22;
			var tVec:b2Vec2;
...
///
		static public function DistancePC(x1:b2Vec2, x2:b2Vec2, polygon:b2PolygonShape, xf1:b2XForm, circle:b2CircleShape, xf2:b2XForm):Number
		{
